<?php $page_title = "About Us | Leading HROP Sheet Manufacturer & Supplier in India";
$description = "Learn more about our journey as a trusted HROP Sheet manufacturer in India. We specialize in producing durable, high-quality Hot Rolled Pickled and Oiled Sheets for various industrial and construction applications.";
$keyword = "About HROP Sheet Manufacturer, Hot Rolled Pickled & Oiled Sheet Supplier, HROP Steel Manufacturer India, Reliable HROP Sheet Company, Industrial Sheet Manufacturer";
 include('header.php');?>
...
.ahead_para       {width: 100%;
    ...
    <div class="about-text" data-aos="fade-left" data-aos-duration="1000">
      ...
      <p>
        ...
        redefining quality and trust in the Indian steel industry, and we 
  ...
  <div class="journey_txt1" data-aos="fade-left" data-aos-duration="1000">
    ...
    <p>What started out as a small business with a clear goal has grown 
      into a well-known brand throughout India's steel supply chain. Our 
...
<section class="misvis">
  ...
  <div class="vis">
    <div class="vis_txt">
      <h1>Our Vision</h1>
      <p>To be one of India's most reputable steel producers and suppliers, 
...
<section class="ahead">
  ...
  <div class="ahead_para">
    ...
    objective of dominating the steel manufacturing industry in India 
